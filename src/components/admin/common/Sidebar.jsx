...
const Sidebar = () => {
  ...
  return (
    <nav class="fixed left-0 top-0 h-screen min-w-[250px] overflow-auto bg-[#121e31] px-4 py-6 tracking-wide">
      <div
        class="flex cursor-pointer flex-wrap items-center gap-4"
      ...
      <ul class="space-y-3">
        <li>
          <Link
            to="/admin/dashboard"
            class="flex items-center rounded px-4 py-3 text-sm text-white transition-all hover:bg-gray-700"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              class="mr-4 h-[18px] w-[18px]"
              viewBox="0 0 512 512"
            >
              <path
